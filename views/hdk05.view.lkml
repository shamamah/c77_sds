view: hdk05 {
  sql_table_name: dbo.HDK05 ;;

  dimension: a00_h5_pol_num {
    type: string
    sql: ${TABLE}.A00_H5_POL_NUM ;;
  }

  dimension: a02_h5_rating_state {
    type: string
    sql: ${TABLE}.A02_H5_RATING_STATE ;;
  }

  dimension: a05_h5_sds_line {
    type: string
    sql: ${TABLE}.A05_H5_SDS_LINE ;;
  }

  dimension: a15_h5_rec_id {
    type: string
    sql: ${TABLE}.A15_H5_REC_ID ;;
  }
  ...
  dimension: a30_h5_hist_exp_date {
    type: number
    sql: ${TABLE}.A30_H5_HIST_EXP_DATE ;;
  }
  ...
  dimension: b79_h5_item_seq {
    type: number
    sql: ${TABLE}.B79_H5_ITEM_SEQ ;;
  }

  dimension: b83_h5_class_cd {
    type: string
    sql: ${TABLE}.B83_H5_CLASS_CD ;;
  }
  ...
  dimension: b94_h5_location {
    type: number
    sql: ${TABLE}.B94_H5_LOCATION ;;
  }
  ...
  dimension: c87_h5_cov_a81_m5_end {
    type: string
    sql: ${TABLE}.C87_H5_COV_A81_M5_END ;;
  }
  ...
  dimension: s06_h5_building {
    type: number
    sql: ${TABLE}.S06_H5_BUILDING ;;
  }
