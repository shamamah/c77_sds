view: hdk04 {
  sql_table_name: dbo.HDK04 ;;

  dimension: a00_h4_pol_num {
    type: string
    sql: ${TABLE}.A00_H4_POL_NUM ;;
  }

  dimension: a02_h4_rating_state {
    type: string
    sql: ${TABLE}.A02_H4_RATING_STATE ;;
  }

  dimension: a05_h4_sds_line {
    type: string
    sql: ${TABLE}.A05_H4_SDS_LINE ;;
  }
  ...
  dimension: a30_h4_hist_exp_date {
    type: number
    sql: ${TABLE}.A30_H4_HIST_EXP_DATE ;;
  }
  ...
  dimension: a9_k_oct_code {
    type: string
    sql: ${TABLE}.A9K_OCT_CODE ;;
  }
  ...
  dimension: b79_h4_item_seq {
    type: number
    sql: ${TABLE}.B79_H4_ITEM_SEQ ;;
  }
  ...
  dimension: b83_h4_class_code {
    type: string
    sql: ${TABLE}.B83_H4_CLASS_CODE ;;
  }
  ...
  dimension: b94_h4_location {
    type: number
    sql: ${TABLE}.B94_H4_LOCATION ;;
  }
  ...
  dimension: s06_h4_building {
    type: number
    sql: ${TABLE}.S06_H4_BUILDING ;;
  }
