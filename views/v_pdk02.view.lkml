view: v_pdk02 {
  sql_table_name: dbo.vPDK02 ;;

  dimension: a00_m2_pol_num {
    type: string
    sql: ${TABLE}.A00_M2_POL_NUM ;;
  }
  ...
  dimension: a30_m2_hist_exp_date {
    type: number
    sql: ${TABLE}.A30_M2_HIST_EXP_DATE ;;
  }
  ...
  dimension: b25_m2_name_type {
    type: string
    sql: ${TABLE}.B25_M2_NAME_TYPE ;;
  }

  dimension: b26_m2_name_seq {
    type: number
    sql: ${TABLE}.B26_M2_NAME_SEQ ;;
  }
