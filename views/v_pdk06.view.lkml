view: v_pdk06 {
  sql_table_name: dbo.vPDK06 ;;

  dimension: a00_m6_pol_num {
    type: string
    sql: ${TABLE}.A00_M6_POL_NUM ;;
  }

  dimension: a02_m6_rating_state {
    type: string
    sql: ${TABLE}.A02_M6_RATING_STATE ;;
  }

  dimension: a15_m6_rec_id {
    type: string
    sql: ${TABLE}.A15_M6_REC_ID ;;
  }
  ...
  dimension: a30_m6_hist_exp_date {
    type: number
    sql: ${TABLE}.A30_M6_HIST_EXP_DATE ;;
  }
  ...
  dimension: b79_m6_item_seq {
    type: number
    sql: ${TABLE}.B79_M6_ITEM_SEQ ;;
  }

  dimension: b80_m6_user_line {
    type: string
    sql: ${TABLE}.B80_M6_USER_LINE ;;
  }

  dimension: b83_m6_class_cd {
    type: string
    sql: ${TABLE}.B83_M6_CLASS_CD ;;
  }

  dimension: b94_m6_location {
    type: number
    sql: ${TABLE}.B94_M6_LOCATION ;;
  }

  dimension: c87_m6_cov_code {
    type: string
    sql: ${TABLE}.C87_M6_COV_CODE ;;
  }
  ...
  dimension: s06_m6_building {
    type: number
    sql: ${TABLE}.S06_M6_BUILDING ;;
  }
