view: hrc09 {
  sql_table_name: dbo.HRC09 ;;

  dimension: a00_h9_pol_num {
    type: string
    sql: ${TABLE}.A00_H9_POL_NUM ;;
  }

  dimension: a02_h9_rating_state {
    type: string
    sql: ${TABLE}.A02_H9_RATING_STATE ;;
  }

  dimension: a05_h9_sds_line {
    type: string
    sql: ${TABLE}.A05_H9_SDS_LINE ;;
  }

  dimension: a15_h9_rec_id {
    type: string
    sql: ${TABLE}.A15_H9_REC_ID ;;
  }
  ...
  dimension: a30_h9_hist_exp_date {
    type: number
    sql: ${TABLE}.A30_H9_HIST_EXP_DATE ;;
  }

  dimension: a81_h9_endorsement_number {
    type: string
    sql: ${TABLE}.A81_H9_ENDORSEMENT_NUMBER ;;
  }
  ...
  dimension: b79_h9_item_seq {
    type: number
    sql: ${TABLE}.B79_H9_ITEM_SEQ ;;
  }
  ...
  dimension: b94_h9_location {
    type: number
    sql: ${TABLE}.B94_H9_LOCATION ;;
  }
  ...
  dimension: s06_h9_building {
    type: number
    sql: ${TABLE}.S06_H9_BUILDING ;;
  }
